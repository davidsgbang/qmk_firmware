...
KC_LSFT,        U_NA,           U_NA,           U_NA,           CW_TOGG,        KC_QUOT,        KC_MINS,        KC_EQL,         KC_LBRC,        KC_RBRC, \
KC_LCTL,        KC_LGUI,        KC_LALT,        U_NA,           U_NA,           U_NA,           KC_BSLS,        U_NA,           U_NA,           U_NA,  \
                                U_NA,           KC_ESC,         MO(NAV),        _______,        KC_DEL,         U_NA

// SYM.
#define LAYOUT_LAYER_SYM                                                                        \
KC_EXLM,        KC_AT,          KC_HASH,        KC_DLR,         KC_PERC,        KC_CIRC,        KC_AMPR,        KC_ASTR,        KC_LPRN,        KC_RPRN,    \
KC_LSFT,        U_NA,           U_NA,           U_NA,           CW_TOGG,        KC_DQT,         KC_UNDS,        KC_PLUS,        KC_LCBR,        KC_RCBR, \
KC_LCTL,        KC_LGUI,        KC_LALT,        U_NA,           U_NA,           U_NA,           KC_PIPE,        KC_LT,          KC_GT,          KC_QUES,  \
